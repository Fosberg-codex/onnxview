...
export default function GettingStartedPage() {
  return (
    <div className="mb-8">
          ...
          <p className="mb-4">
            For more detailed instructions on using PlutoFlow Experimentl, contact <Link href="mailto:fosberg1addai@gmil.com" className="underline text-pink-500">Fosberg.</Link>
