        ...
        <section>
          <ul className="list-disc list-inside space-y-2 mb-4">
            ...
            <li>
              ...
              <p className="ml-6 mt-2">A: This could be due to precision differences or unsupported operations. Try using a different open source version or check if all operations in your model are supported in ONNX.</p>
            </li>
          </ul>
        </section>
      </div>
