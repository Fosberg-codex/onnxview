        ...
        <div className='flex flex-col lg:flex-row items-center gap-4 w-full'>
            <div className='flex flex-col gap-2 justify-center items-start w-full lg:w-1/2'>
                ...
                <div className='flex flex-col sm:flex-row items-center gap-4 mt-4 w-full'>
                    <div className='px-3 py-2 rounded-full bg-blue-900 text-base sm:text-lg text-white text-center w-full sm:w-auto'>get started for free</div>
                    <div className='px-3 py-2 rounded-full border border-blue-900 text-base sm:text-lg text-blue-900 text-center w-full sm:w-auto mt-2 sm:mt-0'>join the alpha waitlist</div>
                </div>
